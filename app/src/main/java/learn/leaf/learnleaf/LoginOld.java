...
public class LoginOld extends AppCompatActivity {
    ...
    private static final String TAG = "LoginOld";
    ...
    private void setListeners() {
        back.setOnClickListener(v -> {
            startActivity(new Intent(LoginOld.this, SignUp.class));
            finish();
        });
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginOld.this, "Password reset email sent", Toast.LENGTH_SHORT).show();
                            } else {
                                // Failed to send password reset email
                                Toast.makeText(LoginOld.this, "Failed to send password reset email", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
    ...
    private void signInWithEmail() {
        ...
        if (em.isEmpty() || pw.isEmpty()) {
            Toast.makeText(LoginOld.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            startActivity(new Intent(LoginOld.this, Tasks.class));
            finish();
        }
    }
}